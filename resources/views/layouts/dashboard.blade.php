                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Server Status</a>
                                </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> Kerusakan<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{route('rusak.forms')}}">Input Data Kerusakan</a>
                                </li>
                                <li>
                                    <a href="#">Cek Progress</a>
                                </li>
                                <li>
                                    <a href="#">List Data Kerusakan</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
